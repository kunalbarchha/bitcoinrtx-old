...
from test_framework import BitcoinrtxTestFramework
...
class TxnMallTest(BitcoinrtxTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BRTX:
        ...
        # First: use raw transaction API to send 1210 BRTX to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50BRTX for another
        ...
        # Node0's total balance should be starting balance, plus 100BRTX for 
