...
###   This script attempts to download the signature file SHA256SUMS.asc from bitcoinrtx.org
...
WORKINGDIR="/tmp/bitcoinrtx"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://bitcoinrtx.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://bitcoinrtx.org/bin/"
VERSIONPREFIX="bitcoinrtx-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'bitcoinrtx-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[bitcoinrtx-]<version>-[rc[0-9]] (example: bitcoinrtx-0.9.2-rc1)"
   echo "wget output:"
