...
unlocked to sign the Bitcoinrtx-Qt.app bundle.
...
allowing somebody to distribute a Bitcoinrtx-Qt.app or bitcoinrtx-qt-setup.exe with a valid
...
that the bitcoinrtx-qt.exe file inside the installer had not been tampered with.
