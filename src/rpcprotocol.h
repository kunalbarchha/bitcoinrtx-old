...
#ifndef BITCOINRTX_RPCPROTOCOL_H
#define BITCOINRTX_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Bitcoinrtx is not connected
...
#endif // BITCOINRTX_RPCPROTOCOL_H
