...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Bitcoinrtx Core bitcoinrtx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinrtx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinrtx transaction") + "\n" +
              "  bitcoinrtx-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinrtx transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutAddr(CMutableTransaction& tx, const string& strInput)
{
    ...
    CBitcoinrtxAddress addr(strAddr);
    if (!addr.IsValid())
