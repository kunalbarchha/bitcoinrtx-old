...
#ifndef BITCOINRTX_QT_BITCOINRTXUNITS_H
#define BITCOINRTX_QT_BITCOINRTXUNITS_H
...
/** Bitcoinrtx unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinrtxUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinrtxUnits(QObject *parent);

    /** Bitcoinrtx units.
      @note Source: https://en.bitcoinrtx.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BRTX,
...
typedef BitcoinrtxUnits::Unit BitcoinrtxUnit;

#endif // BITCOINRTX_QT_BITCOINRTXUNITS_H
