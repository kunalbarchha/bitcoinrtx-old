...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/bitcoinrtx"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoinrtx Core"),
     ...
     * override -datadir in the bitcoinrtx.conf file in the default data directory
     * (to be consistent with bitcoinrtxd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
