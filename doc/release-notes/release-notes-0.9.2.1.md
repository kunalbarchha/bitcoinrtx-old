Bitcoinrtx Core version 0.9.2.1 is now available from:

  https://bitcoinrtx.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BRTX to 0.01 BRTX
...
- Fix "Start bitcoinrtx on system login"
