Bitcoinrtx-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinrtx/files/Bitcoinrtx/bitcoinrtx-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoinrtx
...
New/changed settings (command-line or bitcoinrtx.conf file)
--------------------------------------------------------
