Bitcoinrtx version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinrtx/files/Bitcoinrtx/bitcoinrtx-0.5.4/
...
http://gitorious.org/bitcoinrtx/bitcoinrtxd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoinrtx-Qt notifications under Growl 1.3.
Increase required age of Bitcoinrtx-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinrtx properly when installing Bitcoinrtx-Qt over it. (Windows)
