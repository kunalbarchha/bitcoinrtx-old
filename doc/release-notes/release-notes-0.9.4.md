Bitcoinrtx Core version 0.9.4 is now available from:

  https://bitcoinrtx.org/bin/0.9.4/
...
this update is incompatible with the Bitcoinrtx system and could lead to consensus
forks.

Bitcoinrtx Core released binaries from https://bitcoinrtx.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinrtx/+archive/ubuntu/bitcoinrtx
- A third-party or self-compiled Bitcoinrtx Core

upgrade to Bitcoinrtx Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
