Download URL: https://sourceforge.net/projects/bitcoinrtx/files/Bitcoinrtx/bitcoinrtx-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BRTX fee schedule (users still pay 0.01 BRTX per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinrtx00 - #bitcoinrtx99
