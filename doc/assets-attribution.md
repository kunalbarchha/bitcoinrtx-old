The following is a list of assets used in the bitcoinrtx source and their proper attribution.
...
* License: MIT
* Site: [https://bitcoinrtxtalk.org/index.php?topic=15276.0](https://bitcoinrtxtalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original bitcoinrtx logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/bitcoinrtx.icns, src/qt/res/src/bitcoinrtx.svg,
	src/qt/res/src/bitcoinrtx.ico, src/qt/res/src/bitcoinrtx.png,
	src/qt/res/src/bitcoinrtx_testnet.png, docs/bitcoinrtx_logo_doxygen.png,
